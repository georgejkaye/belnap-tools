...
import * as Table from "../theory/Table.res.mjs";
  ...
  return JsxRuntime.jsxs("div", {
              children: [
                ...
                table !== undefined && falsyTable !== undefined && truthyTable !== undefined ? JsxRuntime.jsxs("div", {
                        children: [
                          JsxRuntime.jsx("div", {
                                children: Table.string_of_table(table)
                              }),
                          JsxRuntime.jsx("div", {
                                children: Table.string_of_table(falsyTable)
                              }),
                          JsxRuntime.jsx("div", {
                                children: Table.string_of_table(truthyTable)
                              })
                        ]
                      }) : "",
