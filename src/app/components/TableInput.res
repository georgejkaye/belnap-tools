    ...
    <div className="flex flex-col items-start gap-4">
      ...
      | (Some(t), Some(ft), Some(tt)) =>
        <div className="flex flex-row gap-10">
          <div>
            <div className="pb-2"> {React.string("Original")} </div>
            <TruthTable.FromTable table=t />
          </div>
          <div>
            <div className="pb-2"> {React.string("Falsy")} </div>
            <TruthTable.FromTable table=ft />
          </div>
          <div>
            <div className="pb-2"> {React.string("Truthy")} </div>
            <TruthTable.FromTable table=tt />
          </div>
        </div>
          ...
          <div key={Int.toString(i)}>
            <Mathjax.Context>
              <Mathjax inline={true} dynamic={true}>
                {Expression.latex_of_expression(exp)->Mathjax.inline->React.string}
              </Mathjax>
            </Mathjax.Context>
          </div>
        )
